...
latex_documents = [
    (master_doc, 'pyKaldi.tex', 'pyKaldi Documentation',
     'Doğan Can, Victor Martinez', 'manual'),
]
...
man_pages = [
    (master_doc, 'pykaldi', 'pyKaldi Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pyKaldi', 'pyKaldi Documentation',
     author, 'pyKaldi', 'One line description of project.',
     'Miscellaneous'),
]
