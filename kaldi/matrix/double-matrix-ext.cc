  ...
  if (PyArray_Check(a[0])) {
    ...
    if (dtype == NPY_DOUBLE) {
      ...
      PyErr_SetString(PyExc_RuntimeError,
                      ...
                      "it has an invalid dtype. Supported dtypes: double.");
      return nullptr;
    }
  } else {
...
static PyObject* DoubleVectorToNumpy(PyObject* self, PyObject* args, PyObject* kw) {
  ...
  if (!PyArg_ParseTupleAndKeywords(args, kw, "O:doublevector_to_numpy",
                                   names, &obj)) {
    return nullptr;
  }
  ::kaldi::VectorBase<double>* vector;
  if (!Clif_PyObjAs(obj, &vector)) {
    return ArgError("doublevector_to_numpy", names[0],
...
static PyObject* DoubleMatrixToNumpy(PyObject* self, PyObject* args, PyObject* kw) {
  ...
  if (!PyArg_ParseTupleAndKeywords(args, kw, "O:doublematrix_to_numpy",
                                   names, &obj)) {
    return nullptr;
  }
  ::kaldi::MatrixBase<double>* matrix;
  if (!Clif_PyObjAs(obj, &matrix)) {
    return ArgError("doublematrix_to_numpy", names[0],
...
static PyMethodDef Methods[] = {
  { C("doublevector_to_numpy"), (PyCFunction)numpy::DoubleVectorToNumpy,
    METH_VARARGS | METH_KEYWORDS,
    C("doublevector_to_numpy(vector:VectorBase) -> ndarray\n Convert Kaldi vector to 1-D numpy array.") },
  { C("doublematrix_to_numpy"), (PyCFunction)numpy::DoubleMatrixToNumpy,
    METH_VARARGS | METH_KEYWORDS,
    C("doublematrix_to_numpy(matrix:MatrixBase) -> ndarray\n Convert Kaldi matrix to 2-D numpy array.") },
  {}
};

bool Ready() {
  PyObject* base_cls = ImportFQName("kaldi.matrix._kaldi_vector.DoubleVectorBase");
...
PyObject* Init() {
  PyObject* module = Py_InitModule3("_double_matrix_ext", Methods,
                                    "kaldi matrix extension module");
  if (!module) {
    PyErr_SetString(PyExc_ImportError,
                    "Cannot initialize _double_matrix_ext module.");
    return nullptr;
  }
  ...
  if (PyModule_AddObject(module, "DoubleSubVector", reinterpret_cast<PyObject*>(&pySubVector::wrapper_Type)) < 0) return nullptr;
  if (PyModule_AddObject(module, "DoubleSubMatrix", reinterpret_cast<PyObject*>(&pySubMatrix::wrapper_Type)) < 0) return nullptr;
  if (_import_array() < 0) {
    PyErr_Print();
    PyErr_SetString(PyExc_ImportError,
...
PyObject* Init() {
  ...
  if (PyModule_AddObject(module, "DoubleSubVector", reinterpret_cast<PyObject*>(&pySubVector::wrapper_Type)) < 0) goto err;
  if (PyModule_AddObject(module, "DoubleSubMatrix", reinterpret_cast<PyObject*>(&pySubMatrix::wrapper_Type)) < 0) goto err;
  if (_import_array() < 0) {
    PyErr_Print();
    PyErr_SetString(PyExc_ImportError,
                    "numpy.core.multiarray failed to import");
...
#if PY_MAJOR_VERSION == 2
PyMODINIT_FUNC init_double_matrix_ext(void) {
  __matrix__ext::Ready() &&
  __matrix__ext::Init();
}
#else
PyMODINIT_FUNC PyInit__double_matrix_ext(void) {
...
// SubVector to/from ::kaldi::SubVector<double> conversion
...
bool Clif_PyObjAs(PyObject* py, ::kaldi::SubVector<double>** c) {
  ...
  ::kaldi::SubVector<double>* cpp = __matrix__ext::pySubVector::ThisPtr(py);
...
PyObject* Clif_PyObjFrom(::kaldi::SubVector<double>* c, py::PostConv unused) {
  ...
  reinterpret_cast<__matrix__ext::pySubVector::wrapper*>(py)->cpp = ::clif::Instance<::kaldi::SubVector<double>>(c, ::clif::UnOwnedResource());
  return py;
}
...
PyObject* Clif_PyObjFrom(std::unique_ptr<::kaldi::SubVector<double>> c, py::PostConv unused) {
  if (c == nullptr) Py_RETURN_NONE;
  PyObject* py = PyType_GenericNew(&__matrix__ext::pySubVector::wrapper_Type, NULL, NULL);
  reinterpret_cast<__matrix__ext::pySubVector::wrapper*>(py)->cpp = ::clif::Instance<::kaldi::SubVector<double>>(std::move(c));
  return py;
}
...
PyObject* Clif_PyObjFrom(std::shared_ptr<::kaldi::SubVector<double>> c, py::PostConv unused) {
  if (c == nullptr) Py_RETURN_NONE;
  PyObject* py = PyType_GenericNew(&__matrix__ext::pySubVector::wrapper_Type, NULL, NULL);
  reinterpret_cast<__matrix__ext::pySubVector::wrapper*>(py)->cpp = ::clif::Instance<::kaldi::SubVector<double>>(c);
  return py;
}

PyObject* Clif_PyObjFrom(const ::kaldi::SubVector<double>& c, py::PostConv unused) {
  PyObject* py = PyType_GenericNew(&__matrix__ext::pySubVector::wrapper_Type, NULL, NULL);
  reinterpret_cast<__matrix__ext::pySubVector::wrapper*>(py)->cpp = ::clif::MakeShared<::kaldi::SubVector<double>>(c);
  return py;
}

// SubMatrix to/from ::kaldi::SubMatrix<double> conversion
...
bool Clif_PyObjAs(PyObject* py, ::kaldi::SubMatrix<double>** c) {
  ...
  ::kaldi::SubMatrix<double>* cpp = __matrix__ext::pySubMatrix::ThisPtr(py);
  if (cpp == nullptr) return false;
  *c = cpp;
  return true;
}
...
PyObject* Clif_PyObjFrom(::kaldi::SubMatrix<double>* c, py::PostConv unused) {
  ...
  reinterpret_cast<__matrix__ext::pySubMatrix::wrapper*>(py)->cpp = ::clif::Instance<::kaldi::SubMatrix<double>>(c, ::clif::UnOwnedResource());
  return py;
}
...
PyObject* Clif_PyObjFrom(std::unique_ptr<::kaldi::SubMatrix<double>> c, py::PostConv unused) {
  if (c == nullptr) Py_RETURN_NONE;
  PyObject* py = PyType_GenericNew(&__matrix__ext::pySubMatrix::wrapper_Type, NULL, NULL);
  reinterpret_cast<__matrix__ext::pySubMatrix::wrapper*>(py)->cpp = ::clif::Instance<::kaldi::SubMatrix<double>>(std::move(c));
  return py;
}
...
PyObject* Clif_PyObjFrom(std::shared_ptr<::kaldi::SubMatrix<double>> c, py::PostConv unused) {
  if (c == nullptr) Py_RETURN_NONE;
  PyObject* py = PyType_GenericNew(&__matrix__ext::pySubMatrix::wrapper_Type, NULL, NULL);
  reinterpret_cast<__matrix__ext::pySubMatrix::wrapper*>(py)->cpp = ::clif::Instance<::kaldi::SubMatrix<double>>(c);
  return py;
}

PyObject* Clif_PyObjFrom(const ::kaldi::SubMatrix<double>& c, py::PostConv unused) {
  PyObject* py = PyType_GenericNew(&__matrix__ext::pySubMatrix::wrapper_Type, NULL, NULL);
  reinterpret_cast<__matrix__ext::pySubMatrix::wrapper*>(py)->cpp = ::clif::MakeShared<::kaldi::SubMatrix<double>>(c);
  return py;
}
